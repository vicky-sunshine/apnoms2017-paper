...
% Clients use port 68 as the source port and port 67 as the destination port.
% By contrast, the server uses port 67 as the source port and port 68 as the destination port.
